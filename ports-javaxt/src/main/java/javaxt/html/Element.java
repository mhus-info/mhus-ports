...
public class Element {
	...
	/**
	 * @param html
	 *            HTML used to define a tag (e.g. &lt;div id="1"&gt;)
	 */
	...
	// **************************************************************************
	/**
	 * Removes all HTML tags and attributes inside this element, leaving the raw
	 * rendered text.
	 */
	...
	// **************************************************************************
	/**
	 * Returns the value for a given attribute. If no match is found, returns an
	 * empty string.
	 */

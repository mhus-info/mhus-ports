...
public class Parameters {
	...
	public Parameter getParameter(String ParameterName) {
		if (Parameters == null)
			...
			return getParameter(Parameters, ParameterName);
	}
	...
	// <editor-fold defaultstate="collapsed" desc="Convert Parameters to
	// HTML/Web Form. Click on the + sign on the left to edit the code.">

	/** Used to generate html form inputs */
	public String toHTML() {

		String buttons = "<div><br>"
		        + "<input type=\"submit\" value=\"Invoke\" name=\"Invoke\" class=\"button\">&nbsp;&nbsp;"
		        + "<input type=\"reset\" value=\"Reset\" name=\"Reset\" class=\"button\">" + "</div>" + vbCrLf;
		...
		if (Parameters == null) {
			...
			html.append(vbCrLf);
			html.append("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse:collapse;\">"
			        + vbCrLf);
			addRows(Parameters);
	...
	private void addRow(Parameter Parameter) {
		...
		if (ParameterType.equalsIgnoreCase("String")) {
			...
			InputHTML = "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse:collapse;\">"
			        + "<tr>" + "<td><input type=\"radio\" value=\"TRUE\" checked name=\"" + InputName + "\"></td>"
			        + "<td>TRUE</td>" + "<td>&nbsp;&nbsp; </td>"

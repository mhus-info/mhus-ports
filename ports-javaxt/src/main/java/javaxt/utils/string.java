...
public class string {
	...
	public static String replace(String str, String target, String replacement) {
		CharSequence Target = target;
		CharSequence Replacement = replacement;
	...
	// ** instr
	// **************************************************************************
	public static int InStr(String str, String ch) {
		return instr(str, ch);
	}
	...
	public static String RTrim(String str) {
		...
		while (str.endsWith(" ") || str.endsWith("\r") || str.endsWith("\n") || str.endsWith("\t")) {
	...
	public static String LTrim(String str) {
		...
		while (str.startsWith(" ") || str.startsWith("\r") || str.startsWith("\n") || str.startsWith("\t")) {
			str = str.substring(1);
		}
		return str;
	}
	...
	/** Used to convert a string to a double. */
	public static double cdbl(String d) {
		return toDouble(d);
	}
	...
	public static String cstr(double d) {
		...
		/*
		 * String s = d + ""; if (s.contains((CharSequence) "E-")){
		 ...
		 * s.replace((CharSequence)".", (CharSequence)""); for (int i=0; i<e;
		 * i++){ s = "0" + s; } s = "0." + s; } else{ //this is incomplete/wrong
		 * int i = s.indexOf(".") + e; s = s.replace((CharSequence)".",
		 * (CharSequence)""); s = s.substring(0,i) + "." + s.substring(i); }
		 * 

...
public class Field {
	...
	protected Field(int i, java.sql.ResultSetMetaData rsmd) {
		try {
			Name = getValue(rsmd.getColumnName(i));
		} catch (Exception e) {
		}
		try {
			Table = getValue(rsmd.getTableName(i));
		} catch (Exception e) {
		}
		try {
			Schema = getValue(rsmd.getSchemaName(i));
		} catch (Exception e) {
		}
		try {
		...
		try {
			Class = getValue(rsmd.getColumnClassName(i));
		} catch (Exception e) {
		}
	...
	// **************************************************************************
	/**
	 * Returns the Java class name that is associated with the column type. For
	 * example, most JDBC drivers map VARCHAR columns to a java.lang.String. In
	 * this case, the method would return "java.lang.String" for the field class
	 * name.
	 */

...
public class Parser {
	...
	private static String[] joinTypes = new String[] {
	        // Order is important!
	        "RIGHT OUTER JOIN", "RIGHT INNER JOIN", "FULL OUTER JOIN", "LEFT OUTER JOIN", "LEFT INNER JOIN",
	        "NATURAL JOIN", "RIGHT JOIN", "INNER JOIN", "OUTER JOIN", "CROSS JOIN", "LEFT JOIN", "JOIN" };
	...
	public class FromStatement {
		...
		public void addColumn(String columnName) {
			...
			if (isExposed(columnName))
				exposedElements.add(columnName);
		}
	...
	private String addQuotes(java.util.HashSet exposedElements, String sqlFragment) {
		 ...
		 * (itt.hasNext()){ String exposedElement = (String) itt.next();

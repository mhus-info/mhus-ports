...
public class ConnectionPool extends MLog {
	...
	// This class is a modified version of the MiniConnectionPoolManager
	// (version 2012-01-24)
	// Copyright 2007-2012 Christian d'Heureuse, Inventec Informatik AG, Zurich,
	// Switzerland
	...
	// - Removed java.sql.Connection import and replaced "Connection" with
	// "java.sql.Connection"

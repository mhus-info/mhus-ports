...
public class Driver {
	...
	private static Driver[] drivers = new Driver[] {
	        ...
	        new Driver("Microsoft Access", "sun.jdbc.odbc.JdbcOdbcDriver",
	        ...
	        new Driver("JTDS", "net.sourceforge.jtds.jdbc.Driver", "jdbc:jtds"), // Open
	                                                                             // source
	                                                                             // JDBC
	                                                                             // 3.0
	                                                                             // type
	        ...
	        // new Driver("derby //", "org.apache.derby.jdbc.ClientDriver",
	        // "jdbc:derby://"),
	 ...
	 * 
	 * @param vendor
	 *            Name the database/vendor. This keyword used extensively in the
	 *            javaxt.sql.Recordset class to accomodate inconsistant JDBC
	 *            implementations between database vendors. As such, please use
	 *            the names provided in the examples above when connecting to
	 *            SQL Server, DB2, Sybase, and PostgreSQL. Other databases have
	 *            not been tested and do not require reserved keywords.
	 * @param driver
	 *            Class name used to create a java.sql.Driver.
	 * @param protocol
	 *            Protocol used in the jdbc connection string.
	 */
	 ...
	 * 
	 * @param obj
	 *            Accepts either a javaxt.sql.Driver or a String representing

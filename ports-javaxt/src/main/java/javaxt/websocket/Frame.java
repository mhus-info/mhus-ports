 ...
 *   Websocket messages are encapsulated in frames. There are 2 types of
 *   frames: Control Frames (e.g. CloseFrame) and Data Frames (e.g. TextFrame).
 *   This class provides abstract methods to create frames and includes 
 *   subclasses that implement all standard frame types defined in RFC 6455.
 *
 ******************************************************************************/
...
public abstract class Frame {
     ...
     *
     * @throws FrameException thrown if the frame is not a valid frame
     */
    ...
    private static void isFrameValid( Frame inputFrame ) throws FrameException {
        if( inputFrame.isRSV1() || inputFrame.isRSV2() || inputFrame.isRSV3() ) {
            throw new FrameException( 
                "bad rsv" + 
                " RSV1: " + inputFrame.isRSV1() + 
                " RSV2: " + inputFrame.isRSV2() + 

...
//******************************************************************************
/**
 * Implementations of this class are used to parse credentials and authenticate
 * client requests.
 *
 ******************************************************************************/
...
public interface Authenticator {
	 ...
	 * second element represents the password. Client credentials may be found
	 * in the "Authorization" request header, in a client certificate, etc.
	 * Implementations of this class must communicate the authentication scheme
	 * via the getAuthType() method. If the Authenticator fails to parse the
	 * credentials, this method returns a null.
	 */

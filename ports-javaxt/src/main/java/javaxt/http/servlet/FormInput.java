...
public class FormInput {
	...
	protected FormInput(ServletInputStream is, FormInput prevInput, String boundary) throws IOException {
		...
		if (boundary.equals("&")) { // Content-Type:
			...
			// Extract form metadata (e.g. "Content-Type",
			...
			// If the input is a file and no filename is supplied, don't
			// generate
			// a value.
			if (this.isFile()) {
				if (fileName == null)
	...
	// **************************************************************************
	/**
	 * Returns the "filename" attribute found in the "Content-Disposition" value
	 * associated with this form input. This attribute is unique to
	 * "multipart/form-data".
	 */
	...
	// **************************************************************************
	/**
	 * Convenience method used to determine whether the input is associated with
	 * a file upload. Returns true if a "filename" attribute is found in the
	 * "Content-Disposition" metadata. This attribute is unique to
	 * "multipart/form-data".
	 */

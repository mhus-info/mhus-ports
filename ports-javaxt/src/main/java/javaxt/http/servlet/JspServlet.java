 ...
 * <p/>
 *
 * Note that this class is only a partial implementation of the JavaServer Pages
 * 2.1 specification. Tag libraries and other "advanced" features are not
...
public class JspServlet extends HttpServlet {
	 ...
	 */
	protected void compile(java.io.File jspFile) throws java.io.IOException, java.lang.ClassNotFoundException,
	 ...
	 */
	protected void compile(String source, String className)
	        throws java.io.IOException, java.lang.ClassNotFoundException, java.lang.InstantiationException,
					...
					for (int i = 0; i < attributes.getLength(); i++) {
						...
						if (value.length() > 0) {
							if (name.equals("import"))
								imports.add(value);
							else if (name.equalsIgnoreCase("pageEncoding"))
								pageEncoding = value;
							else {
								log().d(name + ": " + value);
							}
		...
		/*
		 * response.setContentType("text/html;charset=ISO-8859-1"); JspFactory

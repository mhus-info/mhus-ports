...
public class Server extends MLog {
	 ...
	 *            <li>-debug to specify whether to output debug messages to the
	 *            standard output stream.</li>
	 *            <li>-dir to specify a path to a directory where html, js, css,
	 *            images are found. The server will server content from this
	 *            directory to web clients.</li>
	 *            </ul>
	 */
	...
	private static InetSocketAddress[] getAddresses(String str) throws IllegalArgumentException {
		java.util.ArrayList<InetSocketAddress> addresses = new java.util.ArrayList<InetSocketAddress>();
